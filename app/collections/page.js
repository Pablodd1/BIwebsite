        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="rounded-xl shadow-sm p-6 mb-8 bg-secondary/75 shadow-gray-400">
                ...
                <div className="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-rows-2 lg:grid-cols-6">
                    ...
                    <RangeCheckboxGroup title="Thickness (mm)" options={thicknessRanges} value={filters.thicknessRange} onChange={v => setFilters(f => ({ ...f, thicknessRange: v }))} />
                    <RangeCheckboxGroup title="Width (cm)" options={widthRanges} value={filters.widthRange} onChange={v => setFilters(f => ({ ...f, widthRange: v }))} />
                    <RangeCheckboxGroup title="Length (cm)" options={lengthRanges} value={filters.lengthRange} onChange={v => setFilters(f => ({ ...f, lengthRange: v }))} />
